...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostPumaOpenApi30.CreateTagRequest();
  });
  ...
  describe('CreateTagRequest', function() {
    it('should create an instance of CreateTagRequest', function() {
      ...
      //var instance = new PostPumaOpenApi30.CreateTagRequest();
      //expect(instance).to.be.a(PostPumaOpenApi30.CreateTagRequest);
    });
