...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostPumaOpenApi30.UpdatePostRequest();
  });
  ...
  describe('UpdatePostRequest', function() {
    it('should create an instance of UpdatePostRequest', function() {
      ...
      //var instance = new PostPumaOpenApi30.UpdatePostRequest();
      //expect(instance).to.be.a(PostPumaOpenApi30.UpdatePostRequest);
    });
