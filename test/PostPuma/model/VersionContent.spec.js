...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostPumaOpenApi30.VersionContent();
  });
  ...
  describe('VersionContent', function() {
    it('should create an instance of VersionContent', function() {
      // uncomment below and update the code to test VersionContent
      //var instance = new PostPumaOpenApi30.VersionContent();
      //expect(instance).to.be.a(PostPumaOpenApi30.VersionContent);
    });
