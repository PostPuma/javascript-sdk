...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostPumaOpenApi30.PostUser();
  });
  ...
  describe('PostUser', function() {
    it('should create an instance of PostUser', function() {
      // uncomment below and update the code to test PostUser
      //var instance = new PostPumaOpenApi30.PostUser();
      //expect(instance).to.be.a(PostPumaOpenApi30.PostUser);
    });
